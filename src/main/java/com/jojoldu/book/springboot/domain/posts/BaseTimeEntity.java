 ...
 */
@Getter
@MappedSuperclass // JPA Entity 클래스들이 BaseTimeEntity을 상속할 경우 @CreatedDate, @LastModifiedDate 를 인식 하도록 하는 어노테이션
@EntityListeners(AuditingEntityListener.class) // BaseTimeEntity class에 Auditing 기능을 포함시키는 어노테이션
